                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="<?= base_url('dashboard'); ?>">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                             <img src="<?= base_url();?>assets/images/CA_BARU.png" alt="homepage" class="light-logo" width="50px" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <div class="col">
                                ...
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo base_url('./uploads/profil/' . $this->session->userdata('gambar')); ?>" alt="user" class="rounded-circle" width="31"></a>
            ...
            <li class="sidebar-item"> 
             ...
             <li class="sidebar-item">
                <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                    <i class="mdi mdi-account-switch"></i><span class="hide-menu">Data Master</span>
                </a>
                <ul aria-expanded="false" class="collapse first-level">
                    <li class="sidebar-item">
                        <a href="<?= base_url('item'); ?>" class="sidebar-link">
                            <i class="mdi mdi-settings"></i><span class="hide-menu">Item</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="<?= base_url('subitem'); ?>" class="sidebar-link">
                            <i class="mdi mdi-repeat"></i><span class="hide-menu">Sub Item</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="sidebar-item"> 
                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('permohonan'); ?>" aria-expanded="false">
                    <i class="mdi mdi-account-switch"></i><span class="hide-menu">Data Permohonan</span>
                </a>
            </li>
            <li class="sidebar-item"> 
                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('divisi'); ?>" aria-expanded="false">
                    <i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Data Divisi</span>
                </a>
            </li>
            <li class="sidebar-item"> 
