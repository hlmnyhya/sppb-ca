                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                href="<?php echo base_url('profil/gudang');?>">
    ...
    <nav class="sidebar-nav">
        <ul id="sidebarnav" class="p-t-30">
            <li class="sidebar-item">
                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('dashboard_gudang'); ?>" aria-expanded="false">
            ...
            <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                    <li class="sidebar-item">
                        <a href="<?= base_url('gudang_permohonan_maintenance'); ?>" class="sidebar-link">
                            <i class="mdi mdi-settings"></i><span class="hide-menu">Divisi Maintenance</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="<?= base_url('gudang_permohonan_proses'); ?>" class="sidebar-link">
                            <i class="mdi mdi-repeat"></i><span class="hide-menu">Divisi Proses</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="<?= base_url('gudang_permohonan_lab'); ?>" class="sidebar-link">
                            <i class="mdi mdi-radioactive"></i><span class="hide-menu">Divisi Lab/GRADING</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="<?= base_url('gudang_permohonan_kantor'); ?>" class="sidebar-link">
