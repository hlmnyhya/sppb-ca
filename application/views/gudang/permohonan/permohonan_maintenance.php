            ...
            <table id="zero_config" class="table table-striped table-bordered">
                 ...
                 <tbody>
                    <?php $no=1; foreach ($permohonan as $user): ?>
                            <?php if ($user->divisi == 'Maintenance'): ?>
                                <tr>
                                    <td><?php echo $no++ ?></td>    
                                    ...
                                    <td>
                                    <!-- <a href="<?php echo base_url('edit/'.$user->id_permohonan); ?>" class="btn btn-success"><i class="mdi                   mdi-check"></i><span>Disetujui</span></a> -->
                                    ...
                                    <a href="<?php echo base_url('cetak_gudang/'.$user->id_permohonan); ?>" class="btn btn-danger">
