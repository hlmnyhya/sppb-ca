    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="tambahDivisiModalLabel">Tambah Data Divisi</h5>
            ...
            <div class="modal-body">
                <!-- Form Tambah Divisi -->
                <form id="formTambahDivisi" action="<?= base_url('tambah_divisi')?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="namaDivisi">Nama Divisi</label>
                        <input type="text" class="form-control" id="namaDivisi" name="divisi" placeholder="Masukkan Nama Divisi" required>
                    </div>
