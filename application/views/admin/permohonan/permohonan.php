                        ...
                        <tr>
                           ...
                           <td class="Alert text-white <?= ($user->status == 'Diperiksa') ? 'bg-warning' :                                     (($user->status == 'Disetujui') ? 'bg-success' : 'bg-primary'); ?>">
                            ...
                            <td>
                              ...
                              <a href="<?php echo base_url('ubah_permohonan/'.$user->id_permohonan); ?>" class="btn btn-warning"><i class="mdi mdi-pencil"></i><span>Ubah</span></a>
                              <a href="<?php echo base_url('hapus_permohonan/'.$user->id_permohonan); ?>" class="btn btn-danger"><i class="mdi mdi-delete"></i><span>Hapus</span></a>
                              <a href="<?php echo base_url('permohonan/detail/'.$user->id_permohonan); ?>" class="btn btn-info"><i class="mdi mdi-eye"></i><span>Detail</span></a>
                            </td>
                        </tr>
                        <?php endforeach;?>
                    </tbody>
