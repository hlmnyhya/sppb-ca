        ...
        <div class="card">
          <div class="card-body">
              <!-- Form Tambah User -->
                ...
                <form id="formTambahUser" action="<?= base_url('edit_permohonan_item')?>" method="POST"
                    enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="kode">Kode</label>
                        <input type="hidden" class="form-control" id="kode" name="id_trans_item"  value="<?php echo $user->id_trans_item; ?>"name="kode">
