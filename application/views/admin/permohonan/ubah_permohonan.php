        ...
        <div class="card">
          <div class="card-body">
              <!-- Form Tambah User -->
                ...
                <form id="formTambahUser" action="<?= base_url('edit_permohonan')?>" method="POST"
                    enctype="multipart/form-data">
                   <div class="form-group">
                        <label for="nomor_sppb">Nomor SPPB</label>
                        <input type="hidden" class="form-control" id="nomor_sppb" name="id_permohonan" value="<?php echo $user->id_permohonan; ?>" name="nomor_sppb">
