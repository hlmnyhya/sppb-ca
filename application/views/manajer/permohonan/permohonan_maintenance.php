                    ...
                    <?php $no=1; foreach ($permohonan as $user): ?>
                            <?php if ($user->divisi == 'Maintenance'): ?>
                              <tr>
                                    ...
                                    <td>
                                    <?php if($user->status == 'Diperiksa'): ?>
                                        <a href="<?php echo base_url('manajer/update_disetujui_maintenance/'.$user->id_permohonan); ?>" class="btn btn-success">
                                    ...
                                    <a href="<?php echo base_url('cetak_manajer/'.$user->id_permohonan); ?>" class="btn btn-danger">
