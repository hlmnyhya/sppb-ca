...
<div class="container-fluid">
    ...
    <br>
        ...
        if ($status == 'Diperiksa') {
            ...
            echo '<img src="' . base_url('./uploads/ttd/' . $t->ttd_ktu) . '" alt="user" class="rounded-circle" width="200">';
        ...
        if ($status == 'Disetujui') {
            ...
            echo '<img src="' . base_url('./uploads/ttd/' . $t->ttd_manajer) . '" alt="user" class="rounded-circle" width="200">';
