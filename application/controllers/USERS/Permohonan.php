...
class Permohonan extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('users/permohonan/permohonan',$data);
	 ...
	 public function get_current_user() 
	 {
        ...
        if ($current_user) {
            // Pengguna sedang login, kembalikan data pengguna
            return $current_user;
        } else {
            // Pengguna tidak login, kembalikan NULL atau lakukan redirect ke halaman login
            return NULL;
        }
    }
	...
	public function Tambah_Item($id_permohonan) 
	{
        ...
        $this->load->view('template/header', $data);
        $this->load->view('template/sidebar_users');
        $this->load->view('users/permohonan/tambah_item', $data);	
        $this->load->view('template/footer');
    }
...
WHERE trans_item.id_permohonan = '$id_permohonan';")->result();
        $this->load->view('template/header', $data);
        $this->load->view('template/sidebar_users');
        $this->load->view('users/permohonan/detail_permohonan', $data);
        $this->load->view('template/footer');
	}
...
WHERE trans_item.id_trans_item = '$id_trans_item';")->result();
		...
		$this->load->view('template/header',$data);
		$this->load->view('template/sidebar_users');
		$this->load->view('users/permohonan/ubah_permohonan_item',$data);
		$this->load->view('template/footer');
	}
	...
	public function update_data_aksi_item() 
{
	...
	public function edit_permohonan($id_permohonan)
	{
		...
		$this->load->view('template/header',$data);
		$this->load->view('template/sidebar_users');
		$this->load->view('users/permohonan/ubah_permohonan',$data);
		$this->load->view('template/footer');
	}
	...
	public function tambah_data_aksi() 
{
    $data = array(
        ...
        'tanggal' => $this->input->post('tanggal'),
        'status' => $this->input->post('status'),
        'ttd_pemohon' => $this->session->userdata('gambar_ttd'), // Mengambil gambar ttd dari sesi pengguna
        'ttd_ktu' => NULL,
        'ttd_manajer' => NULL,
    );

	echo $this->session->userdata('gambar_ttd');
