...
--
-- Host: localhost:3306
-- Generation Time: Dec 17, 2023 at 04:09 AM
...
CREATE TABLE `permohonan` (
  ...
  `nomor_sppb` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `id_divisi` int NOT NULL,
  `nama_pemohon` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `tanggal` date NOT NULL,
  `status` enum('Diajukan','Diperiksa','Disetujui') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nama_pemeriksa` varchar(500) COLLATE utf8mb4_general_ci NOT NULL,
  `nama_manajer` varchar(500) COLLATE utf8mb4_general_ci NOT NULL,
  `ttd_pemohon` varchar(500) COLLATE utf8mb4_general_ci NOT NULL,
  `ttd_ktu` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ttd_manajer` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `permohonan` (`id_permohonan`, `id_users`, `nomor_sppb`, `id_divisi`, `nama_pemohon`, `tanggal`, `status`, `nama_pemeriksa`, `nama_manajer`, `ttd_pemohon`, `ttd_ktu`, `ttd_manajer`) VALUES
...
CREATE TABLE `sub_item` (
  ...
  `id_master_item` int NOT NULL,
  `nama_sub_item` varchar(255) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `trans_item` (`id_trans_item`, `id_permohonan`, `id_master_item`, `id_sub_item`, `kode`, `satuan`, `fisik`, `uraian`, `keterangan`) VALUES
(1, 1, 1, 1, 'AA.A4.48.742.010', 'PCS', 45, 'SEAL TAPE (ISOLATIP)', 'PERLENGKAPAN KERJA HARNIK'),
(2, 3, 1, 1, 'AA.A4.48.742.010', 'PCS', 6, 'TEST', 'QWEQWE'),
(3, 7, 2, 3, 'AA.A4.48.742.010', 'PCS', 10, '213213', 'ngek');
...
CREATE TABLE `users` (
  ...
  `gambar_ttd` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
--
ALTER TABLE `trans_item`
  MODIFY `id_trans_item` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
